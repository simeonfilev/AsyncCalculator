...
public class DeleteInvalidExpressionsJob implements Runnable {
    private StorageInterface storage;
    private static final Logger logger = LogManager.getLogger(CalculateNotCalculatedExpressionsJob.class);

    public DeleteInvalidExpressionsJob(StorageInterface storage) {
    ...
    public void run() {
        try {
            storage.deleteInvalidExpressions();
